...
function buildConfirmationEmail(params: {
  ...
  const prepItems = [
    'A brief summary of your legal support needs or current matter',
    'Any relevant documents, contracts, or correspondence you would like reviewed',
    'Your questions or goals for the consultation',
    'Your preferred communication method and availability going forward',
  ];
        ...
        <tr>
          <td style="padding:32px 36px 0;">
            <div style="display:inline-block;padding:8px 18px;background-color:rgba(53,94,59,0.1);border-radius:20px;margin-bottom:20px;">
              <span style="font-size:13px;color:#355E3B;font-family:Georgia,serif;font-weight:bold;letter-spacing:0.04em;">&#10003; Consultation Confirmed</span>
            </div>
        ...
        <tr>
          <td style="padding:0 36px 28px;">
            <div style="border-top:1px solid ${brand.border};padding-top:24px;">
              <p style="margin:0 0 14px;font-size:14px;font-weight:bold;color:${brand.foreground};font-family:Georgia,serif;text-transform:uppercase;letter-spacing:0.08em;">How to Prepare</p>
              <ul style="margin:0;padding-left:20px;">
                ${prepItems.map((item) => `<li style="margin-bottom:10px;font-size:14px;color:${brand.foreground};line-height:1.7;font-family:Georgia,serif;">${item}</li>`).join('')}
              </ul>
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 36px 28px;">
            <div style="background-color:rgba(53,94,59,0.06);border:1px solid rgba(53,94,59,0.15);border-radius:10px;padding:18px 22px;">
              <p style="margin:0 0 6px;font-size:13px;font-weight:bold;color:#355E3B;font-family:Georgia,serif;">Access Your Client Portal</p>
