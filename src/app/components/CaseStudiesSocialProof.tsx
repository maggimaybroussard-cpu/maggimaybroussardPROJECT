...
const STATIC_FALLBACK: CaseStudy[] = [
  {
    ...
    summary:
      'A 12-attorney firm faced a complex multi-party commercial dispute with 4,200+ documents and 11 depositions — six weeks from trial. Delivered fully indexed exhibits, 11 deposition summaries, and 8 trial binders 72 hours before trial.',
    published: true,
    sort_order: 1,
  },
  {
    ...
    summary:
      'Audited 34 active SaaS vendor agreements before a Series B close. Identified 12 material risk issues, renegotiated 8 agreements, and delivered investor-ready risk summaries — closing on schedule with zero delay.',
    published: true,
    sort_order: 2,
  },
  {
    ...
    summary:
      'Delivered a 14-page research memo with 22 annotated appellate decisions and a ready-to-file argument outline in 5 business days. Motion granted at the initial hearing.',
    published: true,
    sort_order: 3,
  },
];
