...
export default function ContactCTASection() {
  ...
  return (
    <>
      <section className="py-16 sm:py-24 md:py-32 bg-primary overflow-hidden relative" id="cta" aria-label="Contact call to action">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 md:px-10 text-center">
          <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.35em] sm:tracking-[0.4em] text-accent mb-5 sm:mb-6 md:mb-7 flex items-center justify-center gap-2 sm:gap-3">
            <span className="w-6 sm:w-8 h-px bg-accent/70" />
            Ready to Begin
            <span className="w-6 sm:w-8 h-px bg-accent/70" />
          </p>
          <h2 className="text-section-heading text-primary-foreground mb-4 sm:mb-5 md:mb-7">
            Let&apos;s work
            <br />
          ...
          {/* CTAs — stacked on mobile, wrapping row on sm+ */}
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-3 sm:gap-4">
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-4 bg-accent text-accent-foreground rounded-full text-xs font-semibold uppercase tracking-[0.15em] hover:opacity-90 active:scale-[0.98] transition-all duration-300 hover:gap-4 shadow-lg shadow-accent/20 min-h-[52px] touch-manipulation"
            >
              Book a Consultation
