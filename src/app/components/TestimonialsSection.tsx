...
const FALLBACK: Testimonial[] = [
{
  ...
  full_quote: 'Maggi May stepped in during a busy stretch and handled our research and document prep with real care. She communicates clearly and delivers on time. We\'ll definitely work with her again when overflow comes up.',
  rating: 5,
...
},
{
  ...
  full_quote: 'I was skeptical about remote paralegals, but Maggi May exceeded my expectations. She handled my document drafting well and met the deadline I needed. My client noticed the faster turnaround.',
  rating: 5,
...
},
{
  ...
  full_quote: 'Her help with trial prep saved me a lot of time. Organized, thorough, and easy to work with. She put together our exhibit binder and deposition notes without me having to follow up.',
  rating: 5,
  service: 'Litigation Support',
...
},
{
  ...
  full_quote: 'Maggi May reviewed several vendor contracts for us and flagged issues we hadn\'t caught. Her summaries were clear and useful. Good value for a small team without a full legal department.',
  rating: 5,
...
},
{
  ...
  full_quote: 'Maggi May helped us get organized before a hearing and it made a real difference. Reliable and professional. She put together our exhibit materials quickly and without errors.',
  rating: 5,
  service: 'Litigation Support',
...
},
{
  ...
  full_quote: 'Good research memo, delivered when she said she would. I\'ll use her again for overflow work. Straightforward to work with and the product was solid.',
  rating: 5,
