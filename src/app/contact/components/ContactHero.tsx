...
export default function ContactHero() {
  return (
    <section className="relative bg-primary overflow-hidden pt-24 pb-10 sm:pt-32 sm:pb-14 md:pt-44 md:pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] sm:tracking-[0.35em] text-accent mb-3 sm:mb-4 md:mb-5 flex items-center gap-2 sm:gap-3">
        ...
        <p className="text-primary-foreground/65 text-sm sm:text-base md:text-lg font-light leading-relaxed max-w-lg mt-4 sm:mt-5 md:mt-6">
