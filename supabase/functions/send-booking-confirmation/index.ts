  ...
  try {
    ...
    const bodyHtml = `
      ...
      <head>
        ...
        <title>Consultation Confirmed — Broussard Legal Services</title>
        <!--[if !mso]><!-->
              ...
              <tr>
                <td style="padding: 0 36px 32px;">
                  ...
                  <p style="margin:0 0 20px; font-size:15px; color:${brand.foreground}; line-height:1.8; font-family: Georgia, serif;">
                    Thank you for booking a consultation with Broussard Legal Services. Your appointment is confirmed and I look forward to speaking with you.
                  </p>
